...
def extract_document(file_url, api_key, schema=None, schema_prompt=None, 
                    figure_processing=None, extensions=None):
    """
    ...
    if figure_processing:
        data['figure_processing'] = figure_processing
    if extensions:
