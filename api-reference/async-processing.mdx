...
job = client.schema(
    ...
    schema_config={"input_schema": {...}, "schema_prompt": "..."},
    async_=True
)
...
job = client.split(
    extraction_id="abc123",
    split_config={"split_input": [{"name": "financials", "description": "..."}]},
    async_=True
)
```
...
// Async schema extraction
const schemaJob = await client.schema({
    extraction_id: "abc123",
    schema_config: { input_schema: {}, schema_prompt: "Extract details" },
    async: true
});
```
