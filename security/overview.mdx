...
<CardGroup cols={2}>
  ...
  <Card title="ISO 27001" icon="certificate">
    Information security management certification (certified)
  </Card>
</CardGroup>
...
Visit our [Trust Center](https://trust.runpulse.com) for detailed security and compliance information.
...
Contact [security@trypulse.ai](mailto:security@trypulse.ai) for compliance documents.
