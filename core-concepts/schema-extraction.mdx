...
result = client.extract(file_url="invoice.pdf", schema=schema)
```
...
result = client.extract(file_url="contract.pdf", schema=schema)
```
...
result = client.extract(file_url="medical_record.pdf", schema=schema)
```
...
```python
try:
    result = client.extract(file_url="doc.pdf", schema=invalid_schema)
...
result = client.extract(file_url="order.pdf", schema=schema)
